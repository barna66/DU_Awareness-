...
<html lang="en" class="no-js">
    ...
    <body>
		...
		<form action="topic.php" method="post" enctype="multipart/form-data">
			...
			<br><br>
			<p class="bText"><label>Subject</label>
			<input type="text" name="subject" size="30" value="" required/>
			</p>
			<br>
			<p class="bText"><label>Message</label>
			<textarea name="message" rows="10" style="width:500px;" required></textarea>
			</p>
			<p>
