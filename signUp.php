...
<hr style="border-color:black;">
		...
		<b>Sign Up</b>
		<br>
		<p class="bText"><label>Name</label>
		<input type="text" id="inputText" name="name" size="40" onchange="check()" value="" required/>
		</p>
		<p class="bText"><label>Email</label>
		<input type="text" id="inputText" name="email" size="40" onchange="check()" value="" required/>
		</p>
		<p class="bText"><label>Phone</label>
		<input type="text" id="inputText" name="phone" size="40" onchange="check()" onkeypress='return event.charCode >= 48 && event.charCode <= 57' value="" required/>
		</p>
		<p class="bText"><label>Address</label>
		<input type="text" name="address" size="40" value="" required/>
		</p>
		<p class="bText"><label>Password</label>
		<input type="password" id="inputText" name="password" size="20" onchange="check()" value="" required/>
		</p>
		<p>
